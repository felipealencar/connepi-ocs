<?php /* Smarty version 2.6.26, created on 2016-08-26 06:50:39
...
<br/>
			...
			<?php if ($this->_tpl_vars['allowRegAuthor']): ?>
				<input type="checkbox" id="authorRole" name="authorRole" <?php if ($this->_tpl_vars['isAuthor'] || $this->_tpl_vars['authorRole']): ?>checked="checked" <?php endif; ?> readonly/>&nbsp;<?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'authorRole','key' => "user.role.author"), $this);?>
<br/>
			<?php endif; ?>
