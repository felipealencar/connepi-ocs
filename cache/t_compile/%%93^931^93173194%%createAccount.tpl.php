<?php /* Smarty version 2.6.26, created on 2016-08-31 22:11:03
         compiled from user/createAccount.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'user/createAccount.tpl', 15, false),array('function', 'translate', 'user/createAccount.tpl', 17, false),array('function', 'fieldLabel', 'user/createAccount.tpl', 45, false),array('function', 'form_language_chooser', 'user/createAccount.tpl', 48, false),array('function', 'html_options_translate', 'user/createAccount.tpl', 114, false),array('function', 'html_options', 'user/createAccount.tpl', 159, false),array('modifier', 'assign', 'user/createAccount.tpl', 20, false),array('modifier', 'escape', 'user/createAccount.tpl', 29, false),array('modifier', 'nl2br', 'user/createAccount.tpl', 212, false),)), $this); ?>
...
<tr valign="top">
	...
	<td class="value"><textarea name="affiliation" id="affiliation" rows="5" cols="40" class="textArea <?php if ($this->_tpl_vars['displayPageHeaderTitle'] == 'CONNEPI'): ?>affiliation-connepi<?php endif; ?>"><?php echo ((is_array($_tmp=$this->_tpl_vars['affiliation'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</textarea></td>
</tr>
...
<tr valign="top">
	...
	<td class="value">
		<?php if ($this->_tpl_vars['allowRegReader'] || $this->_tpl_vars['allowRegReader'] === null): ?>
			<input type="checkbox" name="createAsReader" id="createAsReader" value="1"<?php if ($this->_tpl_vars['createAsReader']): ?> checked="checked"<?php endif; ?> readonly/> <label for="createAsReader"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.role.reader"), $this);?>
...
<br />
		...
		<?php if ($this->_tpl_vars['allowRegAuthor'] || $this->_tpl_vars['allowRegAuthor'] === null): ?>
			<input type="checkbox" name="createAsAuthor" id="createAsAuthor" value="1"<?php if ($this->_tpl_vars['createAsAuthor']): ?> checked="checked"<?php endif; ?> checked="checked" readonly/> <label for="createAsAuthor"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.role.author"), $this);?>
