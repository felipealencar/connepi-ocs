<?php /* Smarty version 2.6.26, created on 2016-09-02 23:36:21
...
][affiliation]" class="textArea <?php if ($this->_tpl_vars['confAcronym'] == 'XI CONNEPI'): ?>affiliation-connepi<?php endif; ?>" id="authors-<?php echo ((is_array($_tmp=$this->_tpl_vars['authorIndex'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
...
<?php if ($this->_tpl_vars['confAcronym'] == 'XI CONNEPI'): ?>
<tr valign="top">
	<td class="label" required="true">Grande Área<?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('required' => 'true'), $this);?>
</td>
	<td width="80%" class="value">
		<select name="area" class="grandes-areas">
			<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['grandesAreas']), $this);?>

		</select>
	</td>
</tr>
<tr valign="top">
	<td class="label" required="true">Áreas de conhecimento<?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('required' => 'true'), $this);?>
</td>
	<td width="80%" class="value">
...
<tr valign="top">
	<td class="label" required="true">Sub Áreas<?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('required' => 'true'), $this);?>
</td>
	<td width="80%" class="value">
...
<tr valign="top">
	<td class="label" >Especialidades<?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('required' => 'true'), $this);?>
</td>
	<td width="80%" class="value">
...
<tr valign="top">
	<td<?php if ($this->_tpl_vars['currentSchedConf']->getLocalizedSetting('metaDisciplineExamples') != ''): ?> rowspan="2"<?php endif; ?> width="20%" class="label"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'discipline','key' => "paper.discipline",'required' => 'true'), $this);?>
</td>
...
" size="40" maxlength="255" <?php if ($this->_tpl_vars['confAcronym'] == 'XI CONNEPI'): ?>readonly<?php endif; ?>/></td>
