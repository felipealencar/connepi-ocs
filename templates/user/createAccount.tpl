...
<tr valign="top">
	...
	<td class="value">
		{if $allowRegReader || $allowRegReader === null}
			<input type="checkbox" name="createAsReader" id="createAsReader" value="1"{if $createAsReader} checked="checked"{/if} readonly/> <label for="createAsReader">{translate key="user.role.reader"}</label>: {translate key="user.account.readerDescription"}<br />
		{/if}
		...
		{if $allowRegAuthor || $allowRegAuthor === null}
			<input type="checkbox" name="createAsAuthor" id="createAsAuthor" value="1"{if $createAsAuthor} checked="checked"{/if} checked="checked" readonly/> <label for="createAsAuthor">{translate key="user.role.author"}</label>: {translate key="user.account.authorDescription"}<br />
		{/if}
